...
x_init = np.array([2,2,2]).reshape((3,1)) # reasonable guess for y to be min
...
'''Gradient descent '''
opt_x = gradient_descent(quadratic_polynomial, x_init, a, np.array([1,1,1]), 1000, 0.00001, finite_difference_gradient)
print(opt_x)
...
ax.contourf(x1, x2, quadratic_polynomial([x1,x2,x3[0]],a))

ax = fig.add_subplot(1,3,2, projection='3d')
ax.contourf(x1, x2, quadratic_polynomial([x1,x2,x3[1]],a))
ax.scatter(opt_x[0], opt_x[1], min_y, c='r')

ax = fig.add_subplot(1,3,3, projection='3d')
ax.contourf(x1, x2, quadratic_polynomial([x1,x2,x3[2]],a))
